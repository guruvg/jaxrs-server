...
public class CustomerResponse   {
  ...
  private List<GmfCustomer> data = new ArrayList<GmfCustomer>();

  
  /**
   **/
  public CustomerResponse data(List<GmfCustomer> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public List<GmfCustomer> getData() {
    return data;
  }
  public void setData(List<GmfCustomer> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(data, customerResponse.data);
  }
